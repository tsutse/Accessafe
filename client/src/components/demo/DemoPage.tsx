...
const DemoPage: React.FC = () => {
  const domain = 'https://accessibility.yourdomain.com'; // This will be replaced with actual domain in production
  const embeddableScript = `<script src="${domain}/dist/hebrew-a11y.min.js" defer></script>`;
  const advancedScript = `<script src="${domain}/dist/hebrew-a11y.min.js" data-position="bottom-left" defer></script>`;
  ...
  return (
    <div dir="rtl" lang="he" className="min-h-screen font-heebo">
      ...
      <header className={`sticky top-0 z-40 transition-all duration-300 ${isScrolled ? 'bg-white/90 backdrop-blur-sm shadow-md' : 'bg-transparent'}`}>
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <ul className="flex space-x-1 space-x-reverse">
                <li><a href="#features" className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition">תכונות</a></li>
                <li><a href="#embed" className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition">הטמעה</a></li>
                <li><a href="/wcag-compliance" className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition">תקן WCAG</a></li>
                <li><a href="/terms" className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition">תנאי שימוש</a></li>
              </ul>
            </motion.nav>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-blue-50 to-white pt-16 pb-24">
        ...
        <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
          <animated.div style={floatAnimation} className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></animated.div>
          <animated.div style={floatAnimation} className="absolute top-1/3 right-1/3 w-96 h-96 bg-indigo-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></animated.div>
          <div className="absolute top-0 left-0 right-0 h-1/2">
            <svg className="absolute left-0 w-full" viewBox="0 0 1440 320" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path opacity="0.05" d="M0,192L48,202.7C96,213,192,235,288,229.3C384,224,480,192,576,181.3C672,171,768,181,864,197.3C960,213,1056,235,1152,229.3C1248,224,1344,192,1392,176L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z" fill="url(#paint0_linear)"></path>
              <defs>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <Badge className="mb-4 px-3 py-1 text-sm bg-blue-100 text-blue-800 border-none">תואם תקן ישראלי 5568</Badge>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-l from-blue-600 to-indigo-700 bg-clip-text text-transparent leading-tight">
                כלי נגישות מתקדם<br />
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-600">לאתרים בעברית</span>
              </h1>
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              כלי הנגישות מציע מגוון רחב של תכונות המסייעות לעמוד בדרישות התקן הישראלי (5568) ותקן WCAG 2.0 ברמת AA
            </motion.p>
          </motion.div>
          ...
          >
            {/* Feature Card 1 */}
            <motion.div variants={itemVariants} className="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-6 shadow-lg border border-blue-100 transition transform hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">אפשרויות להתאמת הצגת התוכן: גודל טקסט, ניגודיות, שחור-לבן והדגשת קישורים.</p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-center">
                  <svg className="h-4 w-4 text-blue-500 ml-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            {/* Feature Card 2 */}
            <motion.div variants={itemVariants} className="bg-gradient-to-br from-white to-indigo-50 rounded-2xl p-6 shadow-lg border border-indigo-100 transition transform hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">מתממשק בצורה חלקה עם כל אתר קיים ללא השפעה על ביצועים או צורך בשינויים נוספים.</p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-center">
                  <svg className="h-4 w-4 text-indigo-500 ml-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
            ...
            {/* Feature Card 3 */}
            <motion.div variants={itemVariants} className="bg-gradient-to-br from-white to-purple-50 rounded-2xl p-6 shadow-lg border border-purple-100 transition transform hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">עומד בדרישות תקן ישראלי 5568 ובתקן הבינלאומי WCAG 2.0 ברמת AA.</p>
              <ul className="space-y-2 text-sm">
                <li className="flex items-center">
                  <svg className="h-4 w-4 text-purple-500 ml-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
      ...
      {/* Embed Code Section */}
      <section id="embed" className="py-20 bg-gradient-to-b from-white to-blue-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          >
            ...
            <motion.p 
              ...
              className="max-w-2xl mx-auto text-lg text-gray-600"
            >
              העתק את הקוד להטמעה והוסף אותו לאתר שלך כדי לספק חוויית נגישות מלאה למשתמשים
            </motion.p>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="order-2 lg:order-1">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3 mb-4 text-yellow-700 text-sm">
                  <div className="flex items-start">
                    <svg className="h-5 w-5 text-yellow-500 mt-0.5 ml-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                    </svg>
                    <div>
                      <strong className="block font-medium mb-1">שים לב!</strong>
                      <p>החלף את הדומיין <code className="bg-yellow-100 px-1 rounded">accessibility.yourdomain.com</code> בכתובת האתר שלך לפני ההטמעה.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">רכיבי תאימות עיקריים</h3>
                </div>
                ...
                <ul className="space-y-4">
                  <li className="flex">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">תפעול באמצעות מקלדת</p>
                      <p className="text-sm text-gray-600">תמיכה מלאה בניווט באמצעות מקלדת לפי סעיפים 2.1.1 ו-2.1.2</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="ml-3 text-blue-600">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">אפשרויות להגדלת טקסט וניגודיות לפי סעיפים 1.4.3, 1.4.4 ו-1.4.8</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="ml-3 text-blue-600">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">תמיכה בטכנולוגיות מסייעות</p>
                      <p className="text-sm text-gray-600">תואם קוראי מסך ועזרים אחרים לפי סעיפים 4.1.1 ו-4.1.2</p>
                    </div>
                  </li>
                </ul>
                ...
                <div className="mt-8">
                  <Button asChild variant="outline" className="border-blue-300">
                    <a href="/wcag-compliance" className="inline-flex items-center">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-blue-600 overflow-hidden">
                  <div className="w-full h-full opacity-10">
                    <svg width="100%" height="100%" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g opacity="0.5">
                        ...
                        <circle cx="200" cy="200" r="100" stroke="white" strokeWidth="6"/>
                        <circle cx="200" cy="200" r="50" stroke="white" strokeWidth="6"/>
                        <line x1="0" y1="200" x2="400" y2="200" stroke="white" strokeWidth="6"/>
                        <line x1="200" y1="0" x2="200" y2="400" stroke="white" strokeWidth="6"/>
                      </g>
                    </svg>
                  </div>
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-white text-center p-8">
                    ...
                    <p className="max-w-xs text-blue-100 mb-6">
                      הכלי פותח בהתאם לדרישות תקן ישראלי 5568 (קווים מנחים לנגישות תכנים באינטרנט)
                    </p>
                    <Badge className="bg-white text-blue-600 border-none px-3 py-1">WCAG 2.0 AA</Badge>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/implementation-example" className="text-gray-400 hover:text-white transition">דוגמת יישום</a></li>
                <li><a href="/wcag-compliance" className="text-gray-400 hover:text-white transition">תאימות WCAG</a></li>
                <li><a href="/terms" className="text-gray-400 hover:text-white transition">תנאי שימוש וכתב ויתור</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <Button className="w-full justify-center bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-none" asChild>
          ...
          <div className="border-t border-gray-800 mt-12 pt-6 text-center">
            <p className="text-gray-500 text-sm">כלי נגישות לאתרים בעברית &copy; 2025 - כל הזכויות שמורות</p>
          </div>
        </div>
      </footer>
